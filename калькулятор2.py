...
photo = tk.PhotoImage(file='fun.png') # картинка
...
tk.Button(text='0', bg='#f1f3f4', font='arial', bd=2, command=lambda: add_digit('0')).grid(row=4, column=0,
                                                                                          stick='wens', padx=5, pady=5)
